...
\end{equation}
\noindent
Die bisherige Regelung der Schaltgabelposition wurde in einem vorangegangenen Advanced Design Project ausgelegt. Dazu wurden mithilfe des Ziegler-Nichols-Verfahren zunächst Parameter für einen PID-Regler ermittelt, welcher allerdings noch zu große Totzeiten und ein Überschwingen aufwies. In einer anschließenden iterativen Optimierung mit Störgrößenkompensation wurden die Regelparameter zu $K_P$ =\SI{2,6}{\%\frac{V}{mm}}, $K_I$ =\SI{20}{\%\frac{V}{s mm}} und $K_D$ =\SI{1,6}{\%\frac{Vs}{mm}} bestimmt. Der Verlauf der Sprungantwort ist in nachstehender \autoref{fig:Sprungantwort Schaltgabelposition} dargestellt.
\begin{figure}[h]
	\centering
