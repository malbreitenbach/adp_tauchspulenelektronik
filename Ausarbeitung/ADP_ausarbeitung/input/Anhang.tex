\appendix
\chapter{Vollständiges Boardlayout}
\begin{figure}[H]%
\centering
...
\chapter{Alternativkonzept auf 4 Layern mit Buck-Converter}
...
\begin{figure}[H]%
\centering
\includegraphics[width=0.9\columnwidth]{./Bilder/buck}%
...
\begin{figure}[H]%
\centering
\includegraphics[width=0.9\columnwidth]{./Bilder/v334layer}%
